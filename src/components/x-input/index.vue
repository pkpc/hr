<template>
    ...
    <div class="weui-cell__bd weui-cell__primary" :class="{'weui-cell__icon': withIcon}" :style="{flex: bdFlex}">
      <input
      v-if="!type || type === 'text'"
      class="weui-input"
      :maxlength="max"
...
import Debounce from '../../tools/debounce/index'
...
.vux-x-input .weui-cell__bd.weui-cell__icon {
  padding-right: 0;
}
.vux-x-input .weui-cell__bd{
  padding-right: 13px;
}
</style>

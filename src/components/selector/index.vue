<template>
   <div class="vux-selector weui-cell" :class="{'weui-cell_select':!readonly, 'weui-cell_select-after':title}">
    <div class="weui-cell__hd" v-if="title" :style="{flex: hdFlex}">
    ...
    <div class="weui-cell__bd" v-if="!readonly" :style="{flex: bdFlex}"  :class="{'weui-cell__icon': withIcon}">
...
.vux-selector .weui-cell__bd.weui-cell__icon {
  padding-right: 0;
}
.vux-selector .weui-cell__bd{
  padding-right: 13px;
}
</style>
